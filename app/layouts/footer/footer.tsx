...
export function Footer() {
  return (
    <footer className="hidden lg:block border-t border-footer-border bg-footer">
      <div className="mx-auto grid max-w-[1600px] grid-cols-[1.6fr_1fr_1fr_1fr] gap-10 px-10 py-11">
      ...
      <div className="border-t border-footer-border">
        <div className="mx-auto flex max-w-[1600px] items-center justify-between px-10 py-4 text-[12.5px] text-muted">
